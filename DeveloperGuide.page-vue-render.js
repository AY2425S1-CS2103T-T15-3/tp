...
with(this){return _c('p',[_v("Here is another example of interactions within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, taking "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(\"del_appt 1\")")]),_v(" API call as an example.")])}
},function anonymous(
) {
